...
const FacturationDetail = () => {
  ...
  return (
    <div>
        <button className="btn-style-1"> <Link className="link-version-btn"to="/facturation"><IoIosArrowBack/> Retour</Link></button>
        <ReactToPrint
            documentTtile = "Facturation"
            onAfterPrint={()=>window.location.reload()}
            trigger={() => <button className="btn-style-1"><AiFillPrinter/> Imprimer la Facture</button>}
